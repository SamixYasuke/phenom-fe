          ...
          <div className="flex gap-x-4 sm:col-span-2">
            <div className="flex h-6 items-center">
              ...
              >
                <span
                  aria-hidden="true"
                  className={`translate-x-0 size-4 transform rounded-full bg-white shadow-sm ring-1 ring-gray-900/5 transition duration-200 ease-in-out ${
                    isChecked ? "translate-x-full bg-indigo-600" : ""
                  }`}
                ></span>
              </button>
            </div>
            <label
              id="headlessui-label-v-34"
              htmlFor="headlessui-switch-v-33"
